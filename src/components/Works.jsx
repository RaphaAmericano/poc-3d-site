    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-3 text-secondary text-[17px] max-w-3x1 leading-[30px]">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Debitis eius sunt repellendus. Quas, cumque esse at nesciunt nisi aspernatur amet perferendis sunt nemo iusto non voluptatibus voluptatem adipisci inventore tenetur!
        </motion.p>
      </div>
